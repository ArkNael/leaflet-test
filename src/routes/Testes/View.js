...
import { Card, Row, Col, Divider, Skeleton, List, Dropdown, Table, message } from 'antd';
...
const View = (props) => {
	...
	return (
		<Card className="gx-card" title="Acompanhar Ocorrência">
		<Row>
			<Col span={8}>
